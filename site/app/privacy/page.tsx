      ...
      <main id="main-content" className="legal-main">
        ...
        <div className="legal-layout section-shell">
          ...
          <article>
            ...
            <section><h2>Individual apps</h2><p>Data practices inside an app are described in that app&apos;s policy. See the <Link href="/apps/queens-regalia/privacy/">Queen&apos;s Regalia privacy policy</Link>.</p></section>
