      ...
      <main id="main-content" className="legal-main">
        ...
        <div className="legal-layout section-shell">
          ...
          <article>
            ...
            <section><h2>Individual apps</h2><p>Data practices inside an app are described in that app&apos;s policy. See the <Link href="/pax/privacy/">Verse &amp; Vale privacy policy</Link> or the <Link href="/queens-regalia-privacy/">Queen&apos;s Regalia privacy policy</Link>.</p></section>
